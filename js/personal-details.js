...
const initPersonalDetails = () => {
  ...
  // Enforce session check on launch - modified to remove authentication guard
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initPersonalDetails);
} else {
  initPersonalDetails();
}
